...
class Stmt extends \PDOStatement implements StmtInterface
{
  ...
  {
    throw new DbException('[:method] Not implement yet...', [
      'method' => __METHOD__,
    ]);
  }
  ...
  public function loadIntoObject($target = \stdClass::class)
  {
    if (is_string($target) && class_exists($target)) {
      ...
      throw new DbException('Target object or class ":class" not found', [
   ...
   * @return mixed
   */
  public function fetch($style = null, $cursor = \PDO::FETCH_ORI_NEXT, $cursorOffset = 0)
  {
